...
public interface AdditionrecursionVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link AdditionrecursionParser#assignment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignment(AdditionrecursionParser.AssignmentContext ctx);
	/**
	 * Visit a parse tree produced by {@link AdditionrecursionParser#println}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrintln(AdditionrecursionParser.PrintlnContext ctx);
	/**
